%% h) Numerisk derivasjon i sann tid 
...
pausetid = 0.1;     % hvor lang skal pausen i while-løkken være 
...
while ~stopp
    if k == 1
        ...
        if noise
            % legger på støy på målesignalet
            u(k) = u(k) + 0.05*randn;
        end
